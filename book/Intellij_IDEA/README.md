...
##### main 메소드가 있는 클래스에서는 main 메소드,

##### JUnit 테스트 케이스의 테스트 메소드에 커서가 있다면 테스트 메소드 1건, 

##### 테스트 메소드가 아닌 곳에 커서가 있다면 테스트 케이스의 테스트 메소드 전체

`Ctrl + Shift + R(Ctrl + Shift + F10)`

##### 커서가 실행 가능한 클래스, 메소드가 아닌 곳에서 이전과 동일한 곳 실행
